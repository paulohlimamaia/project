  ...
  <div>
    ...
    style="width: 100%">
        ...
        <el-table-column
            ...
            <template slot-scope="scope">
                ...
                @click="handleProcessar(scope.row)">Processar</el-button>
                <el-button
                v-else
                size="mini"
                type="success"
                :loading="loadingValidar"
                @click="handleValidar(scope.row.id_file)">Validar</el-button>
                <el-button
                size="mini"
                type="danger"
    ...
    <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
            ...
            <el-button type="success" @click="dialogVisible = false">Validar</el-button>
        </span>
    </el-dialog>
  </div>
</template>
        ...
        methods: {
            ...
            handleProcessar(file){
                ...
                http.get(`/files/${file.id_file}/processar`).then(function(response){
                    ...
                    self.handleValidar(response.data);
                }).catch(function(err){
                    self.loadingProcessar = false;
            ...
            handleValidar(idFile){
                let self = this
                self.loadingValidar = true;
                http.get(`/files/${idFile}/balancos`).then(function(response){
